{
	"tracks": {
		...
		"T0043": {
			...
			"trackDescription": "Incredibly beautiful hike through the Bird Creek Meadows, on the south side of Mount Adams. In mid to late July, this trail offers a multicolor show of wildflowers. There are also two alpine lakes, three really nice waterfalls and many clear cold creeks crisscrossing the meadows. Ah, and a fantastic view of Mt Adams hanging glaciers, melting snow waterfalls and a deep glacier valley -- the Hellroaring Canyon. This is a slight variation of the <a href=\"http://www.wikiloc.com/wikiloc/view.do?id=470787\">Bird Creek Meadows hike</a> which is a bit longer but much more beautiful as you can see two additional waterfalls and more flowery meadows. Bring mosquito repellant.",
			"hasPhotos": true
		},
		"T0044": {
			"trackId": "T0044",
		...
		"T0091": {
			...
			"trackDescription": "Descend through an old growth spruce and helmlock coastal forest down to a meadow with a view of a waterfall plunging to the ocean and continue walking all the way to volcanic rocks where the waves of the Pacific Ocean crash relentlessly.",
			"hasPhotos": true
		},
		"T0092": {
			"trackId": "T0092",
